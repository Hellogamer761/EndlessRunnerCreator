#undef ENDLESSRUNNERCREATOR_API
...
#define UE_PROJECT_NAME EndlessRunnerCreator
#define UE_TARGET_NAME EndlessRunnerCreatorEditor
...
#define ENDLESSRUNNERCREATOR_API DLLEXPORT
